...
enum ViewModelBuilderType { stateless, reactive }
...
class ViewModelBuilder<T extends ChangeNotifier> extends StatefulWidget {
  ...
  const ViewModelBuilder.stateless({
...
class ViewModelBuilderState<T extends ChangeNotifier>
  ...
  Widget build(BuildContext context) {
    if (widget.providerType == ViewModelBuilderType.stateless) {
